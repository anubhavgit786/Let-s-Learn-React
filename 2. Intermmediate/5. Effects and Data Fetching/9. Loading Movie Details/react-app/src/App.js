...
const App = ()=> 
{
  ...
  <>
    ...
    <Main>
      ...
      <Box>
       { selectedId ? (<MovieDetails><SelectedMovieDetails  selectedId={selectedId} onCloseMovie={handleCloseMovie}/> </MovieDetails>) :  (<> <WatchedSummary watched={watched}/> <WatchedMoviesList watched={watched}/> </>) }
      </Box>
    </Main>
  </>);
}
