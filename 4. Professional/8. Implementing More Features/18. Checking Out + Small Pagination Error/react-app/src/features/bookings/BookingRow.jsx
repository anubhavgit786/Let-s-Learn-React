    ...
    <Table.Row role='row'>
      ...
      <Menus.Menu>
        ...
        <Menus.List id={bookingId}>
          ...
          {status === "unconfirmed" && (
          <Menus.Button icon={<HiArrowDownOnSquare />} onClick={handleCheckingIn}>Check in</Menus.Button>)}
          
          {status === "checked-in" && (
          <Menus.Button icon={<HiArrowUpOnSquare />} onClick={handleCheckout} disabled={isCheckingOut}>Check out</Menus.Button>)}
