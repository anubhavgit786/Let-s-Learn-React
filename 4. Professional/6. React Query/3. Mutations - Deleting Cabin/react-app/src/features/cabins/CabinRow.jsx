...
const CabinRow = ({ cabin }) => 
{
  ...
  const {isLoading:isDeleting, mutate } =  useMutation({ mutationFn: deleteCabin, onSuccess: ()=> queryClient.invalidateQueries({ queryKey: ["cabins"] }), onError: (err)=> alert(err.message)  });
  return (
    <TableRow role='row'>
